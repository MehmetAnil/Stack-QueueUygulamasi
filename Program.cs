...
namespace Proje2A2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while(devam.Equals("e", StringComparison.OrdinalIgnoreCase))
            {
                ...
                else if (seçim == 2)
                {
                    ...
                    foreach (Karınca k in karıncaListe)
                    {
                        k.Can = karıncaCan;
                    }
                ...
                for (int j = 0; j < çukurBoyutları.Length; j++)
                {
                    ...
                    if (alan[i] != null && alan[i].GetType().IsValueType)
                    {
                        if (çukurBoyutları[j] != 0 && ((int)alan[i]) == çukurBoyutları[j])
                        {
                            ...
                            ÇukurDüş(karıncaDizi, çukurBoyutları[j],true);
                            çukurBoyutları[j] = 0;
            ...
            for (int i = 0; i < alan.Length; i++)
            {
                for (int j = 0; j < çukurBoyutları.Length; j++)
                {
                    ...
                    if (alan[i] != null && alan[i].GetType().IsValueType)
                    {
                        ...
                        {
                            Console.WriteLine("\n{0} boyutlu Çukur", çukurBoyutları[j]);
                            ÇukurDüş(karıncaListe, çukurBoyutları[j],true);
                            çukurBoyutları[j] = 0;
                ...
                for (int j = 0; j < çukurBoyutları.Length; j++)
                {
                    ...
                    if (alan[i] != null && alan[i].GetType().IsValueType)
                    {
                        if (çukurBoyutları[j] != 0 && ((int)alan[i]) == çukurBoyutları[j])
                        {
                            ...
                            ÇukurDüş(arıListe, çukurBoyutları[j],true);
                            //çukurBoyutları[j] = 0;
                        }
                    }
                }
        ...
        private static int IslemSay() //3 saniyede ortalama kaç adet otopark işlemi çözebildiğini hesaplar.
        {
            int sayac = 0;
            int start, end;
        ...
        static int ÇukurDüş(List<Canlı> karıncaListe, int çukurBoyut,bool islem)
        {
            Stack çukur = new Stack();

            if (karıncaListe.Count < çukurBoyut)
            {
                Console.WriteLine("Karıncalar Sıkıştı.");
                return 0;
            }
        ...
        static void ÇukurDüş(Karınca[] karıncaDizi, int çukurBoyut,bool islem)
        {
            Stack çukur = new Stack();
